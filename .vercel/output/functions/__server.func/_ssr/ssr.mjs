...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-pD7prDPj.mjs");
...
var manifest = {
	"056efed243289ff461e8e1332efbebaf432f93828db89b8459de833c59c232c0": {
		functionName: "getPortalData_createServerFn_handler",
		importer: () => import("./api-BbezBoqy.mjs")
	},
	"0d319e089df299afa0aa3118f1d2cb352601cff7ff8706b9d4532acfb3948c54": {
	...
	"2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
		...
		importer: () => import("../__root-DqJ-vTDM.mjs")
	},
	"3659fad81d4a2fcfe7b9b102e6eea2581cbf2b8f97b2ff2e4a3660ed68d751fc": {
		functionName: "updateProfile_createServerFn_handler",
		importer: () => import("./api-BbezBoqy.mjs")
	},
	"6f6b67d8778b234a0f705ff6d15014b1578aa6fa374a2e8460c2d9d19cd78c7b": {
		functionName: "submitQuote_createServerFn_handler",
		importer: () => import("./quote-D01SLJm8.mjs")
	},
	"a9fcf70d5f819b6669656ec879ad0b156fd5a9b655e3391cc2097470ddb25000": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DYaLm8mN.mjs").then((n) => n.t),
